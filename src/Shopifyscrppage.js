...
<h1 className="checkstorehealth" style={{color: "white", fontSize:"75px"}} >Check your store's health</h1>
...
<button onclick="window.location.href='/Embededpopup.js'" className="Scanbutton" style={{height: "63px",width:"180px", color: "grey",fontSize:"30px", backgroundColor: "#243cbc" }} >Scan</button>            
...
<table width="60%" height = "240"  align="center" style={{backgroundColor: '#3047eb' }}  >
<tr>    

<td>       
<div className="card_text">
<img src="C:/Users/CLSS-PC037/Desktop/bigfm/sho/shopify/src/images/viewicosjp.jpg" height="65" width="55" />
...
<td>
<div className="card_text">
<img src="src/images/viewicosjp.jpg"  height="65" width="55" />
...
<td>
<div className="card_text">
<img src="C:\Users\Corona\Desktop\sho\my-new-app\src\pics\viewico.png"  height="65" width="55"/>
