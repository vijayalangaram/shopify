...
<div className= "BrandCandypopup">
  <br/><br/>
  <h1 style={{ color: "#9ea6b0", align: "left", fontSize: "44px" }}>  <img src="assets/img/finglite.png" /> BrandCandy </h1>
</div>



    
<table className= "" width="65%"  height = "700"  align="center" color="white"  border="1"  style={{backgroundColor: 'grey'}}  >
...
<button onClick= {() => {window.location.href='https://clsslabsdev.myshopify.com/password';}}  className="buttoinstallbrndca" style={{height: "50px",width: "200px", color: "white", backgroundColor: "#3047eb", fontSize:"18px" }} > Install BrandCandy</button>            
</td>
</tr>
<br/>
<br/>
