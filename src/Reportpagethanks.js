...
class Reportpagethanks extends Component {
   render() {
      return (
         ...
         <div className="App" >
            ...
            <table className="Reportpagethankstab" width="65%" height="50" border="1" bardercolor="white" align="center" >
               <tr>
                  <td>
                     <div>
                        <h5 align="center" color="white"><img src="assets/img/lock.png"></img> Thank you for unlocking BrandCandy </h5>
                     </div>
                  </td>
               </tr>
            </table>
...
export default Reportpagethanks;